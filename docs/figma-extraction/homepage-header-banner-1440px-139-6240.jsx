...
export default function HeaderBanner1440px() {
  return (
    <div className="bg-grey-10 border-b border-grey-15 relative w-full" data-name="Banner" data-node-id="139:6240">
      <div className="flex items-center justify-center gap-1.5 px-20 py-3.5 relative w-full">
        ...
        {/* Learn More Link */}
        <p className="font-sans font-medium text-sm leading-6 relative text-white text-center underline whitespace-nowrap z-10 cursor-pointer hover:text-purple-75 transition-colors" data-node-id="139:6302">
          Learn More
        </p>
