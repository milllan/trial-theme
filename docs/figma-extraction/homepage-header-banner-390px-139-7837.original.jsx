export default function HeaderBanner390px() {
  return (
    <div className="bg-[#1A1A1A] border-b border-[#262626] border-solid flex items-center justify-between px-4 py-10 gap-1.5 relative w-full" data-name="Banner" data-node-id="139:7837">
      ...
      {/* Learn More Button */}
      <div className="text-center">
        <p className="font-sans font-medium text-xs leading-[18px] text-white whitespace-nowrap cursor-pointer hover:text-purple-400 transition-colors" data-node-id="139:7899">
          Learn More
        </p>
      </div>

      {/* Arrow Button */}
      <div className="absolute right-0 top-9 bg-white/10 backdrop-blur-sm rounded-[75px] flex items-center justify-center gap-2.5 p-1" data-name="Button" data-node-id="139:7900">
