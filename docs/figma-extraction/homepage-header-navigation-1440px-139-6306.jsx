...
export default function HeaderNavigation1440px() {
  return (
    <div className="bg-grey-10 flex items-center justify-between px-20 py-3.5 relative w-full" data-name="Navigation Bar" data-node-id="139:6306">
      {/* Logo */}
      ...
      <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center gap-6" data-name="Buttons Container" data-node-id="139:6324">
        ...
        <div className="bg-grey-08 border border-grey-15 rounded-lg flex items-center gap-2.5 px-5 py-3 relative shrink-0 hover:bg-grey-15 transition-colors cursor-pointer" data-name="Button" data-node-id="139:6325">
        ...
        {/* Navigation Links */}
        <p className="font-sans font-medium text-sm leading-6 relative shrink-0 text-white whitespace-nowrap hover:text-purple-75 transition-colors cursor-pointer" data-node-id="139:6327">
          About Us
        </p>

        <p className="font-sans font-medium text-sm leading-6 relative shrink-0 text-white whitespace-nowrap hover:text-purple-75 transition-colors cursor-pointer" data-node-id="139:6328">
          Properties
        </p>

        <p className="font-sans font-medium text-sm leading-6 relative shrink-0 text-white whitespace-nowrap hover:text-purple-75 transition-colors cursor-pointer" data-node-id="139:6329">
          Services
        </p>
      </div>

      {/* Contact Us Button */}
      <div className="bg-grey-08 border border-grey-15 rounded-lg flex items-center gap-2 px-5 py-3.5 relative shrink-0 hover:bg-grey-15 transition-colors cursor-pointer" data-name="Button" data-node-id="139:6322">
