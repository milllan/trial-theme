...
const FooterSection = () => {
  ...
  return (
    <footer className="flex items-center w-full py-[100px] px-[162px] bg-grey-08 border-t border-grey-15">
      <div className="w-full max-w-[1596px] mx-auto">
        <div className="flex flex-col gap-[100px]">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex flex-col gap-6 max-w-[350px]">
              ...
              <div className="flex items-center gap-2">
                <div className="w-[32px] h-[32px] bg-purple-60 rounded-[8px] flex items-center justify-center">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 24 24"
              ...
              {/* Description */}
              <p className="text-grey-60 font-sans font-normal text-lg leading-[27px]">
              ...
              <div className="flex flex-col gap-4">
                ...
                <form onSubmit={handleEmailSubmit} className="flex flex-col gap-3">
                  <input
                    ...
                    className="py-[18px] px-[24px] bg-grey-10 border border-grey-15 rounded-[10px] text-white placeholder-grey-50 focus:outline-none focus:border-purple-60 transition-colors"
                    required
                  />
                  <button
                    type="submit"
                    className="py-4.5 px-6 bg-purple-60 rounded-[10px] hover:bg-purple-75 transition-all duration-300 hover:scale-105 text-white font-sans font-medium text-lg leading-[27px]"
                  >
                    Subscribe
                  </button>
                </form>
                ...
                <div className="flex flex-col gap-4">
                  {footerLinks.home.map((link, index) => (
                    <a
                      key={index}
                      href={link.href}
                      className="text-grey-60 font-sans font-normal text-lg leading-[27px] hover:text-white transition-colors"
                    >
                      {link.label}
                    </a>
                  ))}
          ...
          <div className="flex items-center justify-between pt-[50px] border-t border-grey-15">
            {/* Copyright */}
            <p className="text-grey-50 font-sans font-normal text-lg leading-[27px]">
            ...
            <div className="flex items-center gap-6">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="w-[40px] h-[40px] bg-grey-10 border border-grey-15 rounded-[10px] flex items-center justify-center hover:bg-grey-15 hover:border-purple-60 transition-all duration-300"
