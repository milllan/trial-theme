    ...
    <div className="flex flex-col gap-16 items-start relative w-full px-20" data-name="Container" data-node-id="139:6487">
      ...
      <div className="flex gap-40 items-end relative shrink-0 w-full justify-between" data-name="Sub Container" data-node-id="139:6488">
        <div className="flex-0 flex flex-col gap-2.5 grow items-start min-h-0 min-w-0 relative shrink-0" data-name="Text Container" data-node-id="139:6489">
          <h2 className="font-sans font-semibold leading-[1.5] min-w-full relative shrink-0 text-[38px] text-white w-[min-content]" data-node-id="139:6490">
            Featured Properties
          </h2>
          <p className="font-sans font-medium leading-[1.5] min-w-full relative shrink-0 text-[#999999] text-base w-[min-content]" data-node-id="139:6491">
        ...
        <button className="bg-[#1a1a1a] border border-neutral-800 flex gap-2 items-center px-5 py-3.5 relative rounded-lg shrink-0 hover:bg-[#262626] transition-colors" data-name="Button" data-node-id="139:6514">
      ...
      <div className="flex flex-col gap-10 items-start relative shrink-0 w-full" data-name="Sub Container" data-node-id="139:6516">
        <div className="flex gap-5 items-start relative shrink-0 w-full" data-name="Items Container" data-node-id="139:6517">
          {/* Property Card 1 */}
          <div className="flex-0 bg-[#141414] border border-neutral-800 grow min-h-0 min-w-0 relative rounded-[12px] shrink-0 hover:border-purple-500 transition-colors" data-name="Card" data-node-id="139:6518">
            <div className="flex flex-col gap-5 items-start overflow-clip p-[30px] relative rounded-[inherit] w-full">
              <div className="h-64 relative rounded-[10px] shrink-0 w-full overflow-hidden" data-name="Image" data-node-id="139:6519">
                <img alt="Seaside Serenity Villa" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] w-full h-full hover:scale-105 transition-transform duration-300" src={imgImage} />
              </div>
              <div className="flex flex-col gap-6 items-start relative shrink-0 w-full" data-name="Container" data-node-id="139:6520">
                <div className="flex flex-col gap-1 items-start relative shrink-0 w-full" data-name="Text Container" data-node-id="139:6521">
                  ...
                  <p className="font-sans font-medium leading-6 relative shrink-0 text-[#999999] text-base w-full" data-node-id="139:6523">
                    <span>A stunning 4-bedroom, 3-bathroom villa in a peaceful suburban neighborhood... </span>
                    <a href="/properties/seaside-serenity-villa" className="text-white underline hover:text-purple-400 transition-colors cursor-pointer">Read More</a>
                  </p>
                </div>
                <div className="flex gap-1.5 items-start relative shrink-0 w-full flex-wrap" data-name="Sub Container" data-node-id="139:6524">
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6525">
                  ...
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6531">
                  ...
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6540">
                ...
                <div className="flex gap-10 items-end relative shrink-0 w-full justify-between" data-name="Sub Container" data-node-id="139:6549">
                  <div className="flex flex-col items-start leading-6 relative shrink-0" data-name="Text Container" data-node-id="139:6550">
                    <span className="font-sans font-medium relative shrink-0 text-[#999999] text-sm w-full" data-node-id="139:6551">
                      Price
                    </span>
                  ...
                  <button className="flex-0 bg-[#703bf7] flex gap-2 grow items-center justify-center min-h-0 min-w-0 px-5 py-3.5 relative rounded-lg shrink-0 hover:bg-[#8049ff] transition-colors" data-name="Button" data-node-id="139:6553">
          ...
          {/* Property Card 2 */}
          <div className="flex-0 bg-[#141414] border border-neutral-800 grow min-h-0 min-w-0 relative rounded-[12px] shrink-0 hover:border-purple-500 transition-colors" data-name="Card" data-node-id="139:6555">
            <div className="flex flex-col gap-5 items-start overflow-clip p-[30px] relative rounded-[inherit] w-full">
              <div className="h-64 relative rounded-[10px] shrink-0 w-full overflow-hidden" data-name="Image" data-node-id="139:6556">
                <img alt="Metropolitan Haven" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] w-full h-full hover:scale-105 transition-transform duration-300" src={imgImage1} />
              </div>
              <div className="flex flex-col gap-6 items-start relative shrink-0 w-full" data-name="Container" data-node-id="139:6557">
                <div className="flex flex-col gap-1 items-start relative shrink-0 w-full" data-name="Text Container" data-node-id="139:6558">
                  ...
                  <p className="font-sans font-medium leading-6 relative shrink-0 text-[#999999] text-base w-full" data-node-id="139:6560">
                    <span>A chic and fully-furnished 2-bedroom apartment with panoramic city views... </span>
                    <span className="text-white underline hover:text-purple-400 transition-colors cursor-pointer">Read More</span>
                  </p>
                </div>
                <div className="flex gap-1.5 items-start relative shrink-0 w-full flex-wrap" data-name="Sub Container" data-node-id="139:6638">
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6639">
                  ...
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6645">
                  ...
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6654">
                ...
                <div className="flex gap-10 items-end relative shrink-0 w-full justify-between" data-name="Sub Container" data-node-id="139:6586">
                  <div className="flex flex-col items-start leading-6 relative shrink-0" data-name="Text Container" data-node-id="139:6587">
                    <span className="font-sans font-medium relative shrink-0 text-[#999999] text-sm w-full" data-node-id="139:6588">
                      Price
                    </span>
                  ...
                  <button className="flex-0 bg-[#703bf7] flex gap-2 grow items-center justify-center min-h-0 min-w-0 px-5 py-3.5 relative rounded-lg shrink-0 hover:bg-[#8049ff] transition-colors" data-name="Button" data-node-id="139:6590">
          ...
          {/* Property Card 3 */}
          <div className="flex-0 bg-[#141414] border border-neutral-800 grow min-h-0 min-w-0 relative rounded-[12px] shrink-0 hover:border-purple-500 transition-colors" data-name="Card" data-node-id="139:6592">
            <div className="flex flex-col gap-5 items-start overflow-clip p-[30px] relative rounded-[inherit] w-full">
              <div className="h-64 relative rounded-[10px] shrink-0 w-full overflow-hidden" data-name="Image" data-node-id="139:6593">
                <img alt="Rustic Retreat Cottage" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] w-full h-full hover:scale-105 transition-transform duration-300" src={imgImage2} />
              </div>
              <div className="flex flex-col gap-6 items-start relative shrink-0 w-full" data-name="Container" data-node-id="139:6594">
                <div className="flex flex-col gap-1 items-start relative shrink-0 w-full" data-name="Text Container" data-node-id="139:6595">
                  ...
                  <p className="font-sans font-medium leading-6 relative shrink-0 text-[#999999] text-base w-full" data-node-id="139:6597">
                    <span>An elegant 3-bedroom, 2.5-bathroom townhouse in a gated community... </span>
                    <span className="text-white underline hover:text-purple-400 transition-colors cursor-pointer">Read More</span>
                  </p>
                </div>
                <div className="flex gap-1.5 items-start relative shrink-0 w-full flex-wrap" data-name="Sub Container" data-node-id="139:6663">
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6664">
                  ...
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6670">
                  ...
                  <div className="bg-[#1a1a1a] border border-neutral-800 flex gap-1 items-center px-3.5 py-1.5 relative rounded-[28px] shrink-0" data-name="Container" data-node-id="139:6679">
                ...
                <div className="flex gap-10 items-end relative shrink-0 w-full justify-between" data-name="Sub Container" data-node-id="139:6623">
                  <div className="flex flex-col items-start leading-6 relative shrink-0" data-name="Text Container" data-node-id="139:6624">
                    <span className="font-sans font-medium relative shrink-0 text-[#999999] text-sm w-full" data-node-id="139:6625">
                      Price
                    </span>
                  ...
                  <button className="flex-0 bg-[#703bf7] flex gap-2 grow items-center justify-center min-h-0 min-w-0 px-5 py-3.5 relative rounded-lg shrink-0 hover:bg-[#8049ff] transition-colors" data-name="Button" data-node-id="139:6627">
        ...
        {/* Pagination */}
        <div className="border-t border-neutral-800 flex items-start justify-between pt-4 relative shrink-0 w-full" data-name="Container" data-node-id="139:6629">
          <p className="font-sans font-medium leading-6 relative shrink-0 text-[#999999] text-base whitespace-nowrap" data-node-id="139:6630">
            <span className="text-white">01</span>
            <span> of 60</span>
          </p>
          <div className="flex gap-2.5 items-start relative shrink-0" data-name="Buttons Container" data-node-id="139:6631">
            <button className="border border-neutral-800 flex gap-2.5 items-start p-2.5 relative rounded-[69px] shrink-0 hover:bg-[#1a1a1a] transition-colors" data-name="Button" data-node-id="139:6632">
            ...
            <button className="bg-[#1a1a1a] border border-neutral-800 flex gap-2.5 items-start p-2.5 relative rounded-[69px] shrink-0 hover:bg-[#262626] transition-colors" data-name="Button" data-node-id="139:6635">
